export const XLSXIcon = () => {
    return (
        <svg width="16px" height="16px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            />
            <rect fill="#20744a" x="22.487" y="7.439" width="4.323" height="2.2" />
            <rect fill="#20744a" x="22.487" y="10.94" width="4.323" height="2.2" />
            <rect fill="#20744a" x="22.487" y="14.441" width="4.323" height="2.2" />
            <rect fill="#20744a" x="22.487" y="17.942" width="4.323" height="2.2" />
            <rect fill="#20744a" x="22.487" y="21.443" width="4.323" height="2.2" />
            <polygon
                fill="#ffffff"
                fillRule="evenodd"
